...
public class CreditsController : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        GUILayout.BeginArea (new Rect (5, 5, Screen.width - 10, Screen.height - 10 - buttonHeight*3));
        scrollPosition = GUILayout.BeginScrollView (scrollPosition, 
                                                    GUILayout.Width (Screen.width - 10), 
                                                    GUILayout.Height (Screen.height - 10 - buttonHeight*3));
        ...
        GUILayout.EndArea ();       
        if (GUI.Button (new Rect (5, Screen.height - buttonHeight * 3 - 5, (Screen.width - 10)/2, buttonHeight), "GPL 3.0 Part 1 License"))
            display = gpl_part1;
        if (GUI.Button (new Rect (5, Screen.height - buttonHeight * 2 - 5, (Screen.width - 10)/2, buttonHeight), "GPL 3.0 Part 2 License"))
            display = gpl_part2;
        if (GUI.Button (new Rect (5, Screen.height - buttonHeight * 1 - 5, (Screen.width - 10)/2, buttonHeight), "GPL 3.0 Part 3 License"))
            display = gpl_part3;
//        if (GUI.Button (new Rect (Screen.width/2, Screen.height - buttonHeight * 4 - 5, (Screen.width - 10)/2, buttonHeight), "CC-BY-3.0 License Part 1"))
//            display = cc_by_3_part1_txt;
//        if (GUI.Button (new Rect (Screen.width/2, Screen.height - buttonHeight * 3 - 5, (Screen.width - 10)/2, buttonHeight), "CC-BY-3.0 License Part 2"))
//            display = cc_by_3_part2_txt;
        if (GUI.Button (new Rect (Screen.width/2, Screen.height - buttonHeight * 2 - 5, (Screen.width - 10)/2, buttonHeight), "Apache 2.0 License"))
            display = apache;
